...
export const SPEC_SHAPE = `{
  ...
  "chapters": [{ "id": "ch_x", "title": "...", "narrative": "...",
    "pages": [{ "id": "pg_x",
      "template": "full-bleed | hero-left | hero-right | hero-top | two-equal | three-banner | three-sidebar | panoramic-strip | four-grid | four-asymmetric | five-mosaic | six-grid | photo-text | text-photo | text-only",
...
are 2 to 4 sentences.`,
    curation: `Select for the story, not for completeness. Prefer variety of
moments over near-duplicates (same author, same place, within ~3 minutes, or
sharing a dupGroup — pick the best one from each cluster). Use multi-photo
templates (four-grid, five-mosaic, six-grid) to show bursts of activity; use
full-bleed or hero templates for single standout shots. A week-long trip should
land between 25 and 50 pages at an average of ~3 photos per page.`,
...
- Templates and EXACT photo counts:
    ...
    photo-text (1 photo + text block), text-photo (1 photo + text block),
    text-only (0 photos — chapter openers only, not day summaries).
- Mix templates for visual variety. Aim for an average of 3 photos/page.
- Target 25–50 pages total for the book.
...
- Respect template photo counts exactly: full-bleed 1, hero-left/right/top 2,
  two-equal 2, three-banner/sidebar/panoramic-strip 3, four-grid/asymmetric 4,
  five-mosaic 5, six-grid 6, photo-text 1, text-photo 1, text-only 0.
